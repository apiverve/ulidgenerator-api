...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/ulidgenerator',
        'Source': 'https://github.com/apiverve/ulidgenerator-api',
        'Bug Tracker': 'https://github.com/apiverve/ulidgenerator-api/issues'
    },
    classifiers=[
