...
// Request contains the parameters for the ULID Generator API.
//
// Parameters:
...
type Request struct {
	...
	Timestamp int `json:"timestamp,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the ULID Generator API.
