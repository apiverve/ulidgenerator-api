...
```gradle
dependencies {
    implementation 'com.github.apiverve:ulidgenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.ulidgenerator.ULIDGeneratorAPIClient;
import com.apiverve.ulidgenerator.APIResponse;
import com.apiverve.ulidgenerator.APIException;

// Initialize the client
ULIDGeneratorAPIClient client = new ULIDGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("count", 1);
    parameters.put("timestamp", 1609459200000);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/ulidgenerator](https://docs.apiverve.com/ref/ulidgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/ulidgenerator](https://docs.apiverve.com/ref/ulidgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/ulidgenerator-api/issues)
