...
{
    class ULIDGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/ulidgenerator";

        /// <summary>
        /// Make a GET request to the ULID Generator API
        /// </summary>
        static async Task<JsonDocument> CallULIDGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;count&quot;] &#x3D; &quot;5&quot;, [&quot;timestamp&quot;] &#x3D; &quot;1609459200000&quot; };
        ...
        {
            Console.WriteLine("📤 Calling ULID Generator API...\n");

            var result = await CallULIDGeneratorAPI();
