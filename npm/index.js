...
class ulidgeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/ulidgenerator');
        }
        ...
        this.validationRules = {"count":{"type":"integer","required":false,"min":1,"max":100,"default":1},"timestamp":{"type":"integer","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/ulidgenerator`);
        }
    }
...
module.exports = ulidgeneratorWrapper;
